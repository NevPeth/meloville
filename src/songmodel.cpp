...
// void SongModel::setSongs(const QVector<SongData> *newLibrary, const QVector<int> *newVisibleSongs)
// {
//     beginResetModel();
//     library = newLibrary;
...
//     // Notify only the rows that changed so the list doesn't fully repaint
...
//     notify(oldIndex);   // clear old row
//     notify(libraryIndex); // highlight new row
// }
